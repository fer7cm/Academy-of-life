...
class ModeloMultinivel{
	...
	static public function mdlMostrarRed($tabla1, $tabla2, $item, $valor){
		...
		if($item != null && $valor != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT $tabla1.*, $tabla2.* FROM $tabla1 INNER JOIN $tabla2 ON $tabla1.patrocinador = $tabla2.patrocinador_red WHERE $item = :$item AND $tabla1.id_usuario=$tabla2.usuario_red");	
