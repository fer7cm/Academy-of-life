...
function pagarUsuario($id_usuario, $enlace_afiliado, $paypal, $vencimiento, $fechaActual, $id_suscripcion, $patrocinador){
	...
	if($enlace_afiliado != "academy-of-life" && $periodo_comision != 0){
		...
		if ($err) {
			...
			CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
			CURLOPT_CUSTOMREQUEST => "POST",
			CURLOPT_POSTFIELDS => "{\r\n  \"sender_batch_header\": {\r\n    \"sender_batch_id\": \"Payouts_".$aleatorio."_".$enlace_afiliado."_".$fechaActual."\",\r\n    \"email_subject\": \"Tú tienes un pago de Academy of life!\",\r\n    \"email_message\": \"Tú haz recibido un pago de Academy of life! Gracias por usar nuestros servicios!\"\r\n  },\r\n  \"items\": [\r\n    {\r\n      \"recipient_type\": \"EMAIL\",\r\n      \"amount\": {\r\n        \"value\": \"".$periodo_comision."\",\r\n        \"currency\": \"USD\"\r\n      },\r\n      \"note\": \"Gracias por tu participación en nuestra de red de afiliados!\",\r\n      \"sender_item_id\": \"Payouts_".$aleatorio."_".$enlace_afiliado."_".$fechaActual."\",\r\n      \"receiver\": \"".$paypal."\"\r\n    }\r\n      \r\n  ]\r\n}",
			CURLOPT_HTTPHEADER => array(
...
class ModeloPagos{
	...
	static public function mdlActualizarRedUninivel($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET patrocinador_red =:patrocinador_red, periodo_comision =:periodo_comision, periodo_venta = :periodo_venta, fecha_uninivel=:fecha_uninivel WHERE usuario_red = :usuario_red");
		...
		$stmt -> bindParam(":fecha_uninivel", $datos["fecha_uninivel"], PDO::PARAM_STR);
