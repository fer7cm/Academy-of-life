		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<div class="input-group"> 
					...
					<input type="text" class="form-control" id="inputMovil" data-inputmask="'mask':'(999) 999-999'" data-mask>
			...
			<div id="terminos" class="collapse pb-4">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						Los suscritos a saber: ACADEMY OF LIFE, sociedad comercial debidamente constituida por documento privado de Julio 1 de 2020, registrado en Cámara de Comercio el 1 de Julio de 2020, en libro 9, bajo el número 18147, con domicilio principal en la ciudad de Lima, país Peru, identificada con número de NIT.900.661.621-4, representada legalmente por PEPITO PEREZ, mayor de edad, vecino de Lima, identificado con cédula de ciudadanía número 12345678, quien adelante y para todos los efectos del presente contrato se denominará EL FABRICANTE, y Alexander Pierce, persona que acepta estos términos y condiciones, mayor de edad, actuando en nombre propio, quien en adelante y para todos los efectos del presente contrato se denominará EL DISTRIBUIDOR O VENDEDOR, hemos acordado celebrar el presente contrato de DISTRIBUCIÓN AL DETAL DE PRODUCTOS Y SERVICIOS, que se regirá por las siguientes partes y cláusulas: 
...
if(isset($_GET["subscription_id"])){
		...
		"authorization: Basic QVlRVzQ3YS1FZHhXZ2xXeDJfYWQ4TmY4czZGS084ak13ZXpFenNkUXlYZ1BLTGVhOVRYY2pYdW5UZTItd2ZSNXdoSEU0U21KRHJUdnJtcDY6RUdMRnY2ajc4MjBXMjM2UEtseWtrbENMUHI4bFJ4OWxIcnpvVGIyWFY3ek01Q2NxMmJZS0pBUFVGSnptWkhDV1NCZFZ2ZTRlYl9nQkNrdlU=",
		...
		if ($err) {
			...
			if ($err) {
				...
				if($estado == "ACTIVE"){
					...
					//$nuevoPatrocinador = $_COOKIE["patrocinador"];
					$pais = $_COOKIE["pais"];
