...
<div class="container-fluid vistaVideo p-0">
	...
	<div class="container">
		...
		<h1 class="text-center text-white pb-1 pb-lg-4">Vivir bien y feliz depende de ti</h1>
		...
		<div class="row">
			...
			<div class="col-12 col-lg-4 p-3 p-sm-4">
				...
				<div class="bg-white text-center py-5 px-4">
					...
					<p>Ejercítate con una rutina personalizada según tu nivel</p>
			...
			<div class="col-12 col-lg-4 p-3 p-sm-4">
				...
				<div class="bg-white text-center py-5 px-4">
					...
					<p>Encuentra un equilibro entre cuerpo y mente solo para ti</p>
			...
			<div class="col-12 col-lg-4 p-3 p-sm-4">
				...
				<div class="bg-white text-center py-5 px-4">
					...
					<p>Conéctate con tu yo interior y encuentra paz en ti</p>
